...
public class JavaStart_5_2_3 {
	/*
	 * 3)¬вести с клавиатуры число (до миллиарда) которое обозначает количество
	 * долларов и центов пользовател€. ¬ывести это количество прописью. Ќапример:
	 * How much money do you have? 123,34 You have: one hundred twenty three dollars
	 * thirty four cents
	 */
